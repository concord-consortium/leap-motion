...
/***/ function(module, exports, __webpack_require__) {
	...
	var _labTemperatureDeltaJsx = __webpack_require__(261);

	var _labTemperatureDeltaJsx2 = _interopRequireDefault(_labTemperatureDeltaJsx);

	__webpack_require__(244);

	_reactDom2['default'].render(_react2['default'].createElement(_labTemperatureDeltaJsx2['default'], null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LabTemperatureDelta = (function (_React$Component) {
	  ...
	  _createClass(LabTemperatureDelta, [{
	    ...
	    value: function gestureDetected() {
	      _commonJsToolsAvg2['default'].addSample('freq', this.fistBump.freq, Math.round(this.props.freqAvg));
	      var freq = _commonJsToolsAvg2['default'].getAvg('freq');
	      var newTemp = null;
	      ...
	      switch (this.state.leapState) {
	        ...
	        case 'gestureDetected':
	          if (this.state.tempChange === 'none') return _react2['default'].createElement(
	            ...
	            Math.round(this.props.tempIncreaseFreq),
	            '). Do it slowly to decrease the temperature (frequency < ',
	            Math.round(this.props.tempDecreaseFreq),
	            ').'
	          );
	          if (this.state.tempChange === 'increasing') return 'Temperature is increasing (frequency > ' + Math.round(this.props.tempIncreaseFreq) + ').';
	          if (this.state.tempChange === 'decreasing') return 'Temperature is decreasing (frequency < ' + Math.round(this.props.tempDecreaseFreq) + ').';
	      }
	    }
	  }, {
	    key: 'render',
	...
	_reactMixin2['default'].onClass(LabTemperatureDelta, _commonJsMixinsLeapStateHandling2['default']);
	module.exports = exports['default'];
