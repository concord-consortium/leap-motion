...
export default class AlignmentRotation extends React.Component {
  ...
  vectorToDegreeString(vectorArray){
    ...
    let degString = this.radiansToDegrees(vectorArray[0]).toFixed(1) + ", " + this.radiansToDegrees(vectorArray[1]).toFixed(1) + ", " + this.radiansToDegrees(vectorArray[2]).toFixed(1);
    return degString;
  }
  vectorToString(vectorArray){
    let vectorString = vectorArray[0].toFixed(2) + ", " + vectorArray[1].toFixed(2) + ", " + vectorArray[2].toFixed(2);
    return vectorString;
  }
  isFingerPointingUp(){
  ...
  render() {
    ...
    let t = this.vectorToString(handTranslation);
    return (
