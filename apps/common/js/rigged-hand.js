import Detector from 'exports?Detector!./lib/leap-rigged-hand/detector';
...
let initScene = function(element){
  let scope = this;
...
Leap.plugin('riggedHand', function(scope = {}){
  ...
  if (scope.renderFn === undefined) {
    scope.renderFn = () => scope.renderer.render(scope.scene, scope.camera);
  }
...
//    console.timeEnd 'addMesh'
  ...
  let removeMesh = function(leapHand){
