...
const OVERLAY_SIZE = {
  'main': {width: '640px', height: '540px'},
  'small-top': {width: '320px', height: '270px'},
  'small-bottom': {width: '320px', height: '270px'}
};

export default class SeasonsNarrow extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    const overlayClassName = `grasp-seasons-narrow ${activeViewPanel}`;
    const overlayVisible = overlayEnabled && overlayActive;

    return (
      <div>
        <div className='seasons-container-narrow'>
          <div style={{background: '#f6f6f6', width: '960px'}}>
...
reactMixin.onClass(SeasonsNarrow, leapStateHandlingV2);
reactMixin.onClass(SeasonsNarrow, overlayVisibility);
